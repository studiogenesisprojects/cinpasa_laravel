...
class browser extends uploader {
    ...
    protected function sendDefaultThumb($file=null) {
        if ($file !== null) {
            ...
            $thumb = "themes/{$this->config['theme']}/imgfiles/big/$ext.png";
        }
        if (!isset($thumb) || !file_exists($thumb))
            $thumb = "themes/{$this->config['theme']}/imgfiles/big/..png";
    ...
    protected function getFiles($dir) {
        ...
        foreach ($files as $file) {
            ...
            $name = basename($file);
            $ext = file::getExtension($file);
            $bigIcon = file_exists("themes/{$this->config['theme']}/imgfiles/big/$ext.png");
            $smallIcon = file_exists("themes/{$this->config['theme']}/imgfiles/small/$ext.png");
