...
* **maxWidth**: Defines the maximum width of the /imgcanvas element.
* **maxHeight**: Defines the maximum height of the /imgcanvas element.
* **minWidth**: Defines the minimum width of the /imgcanvas element.
* **minHeight**: Defines the minimum height of the /imgcanvas element.
