            ...
            <div class="col-sm-12">
                <div class="element-wrapper">
                    <div class="element-box">
                        ...
                        @endif
                        <form id="formValidate" novalidate="true" method="post" action="{{route('handleUpdateCustomer', $customer->id)}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" value="{{$customer->name}}" data-error="Introduzca un nombre" required>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="order" class="form-control" value="{{$customer->order}}" data-error="Introduzca un orden" required>
                                        <div class="help-block form-text with-errors form-control-feedback"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="web" class="form-control" value="{{$customer->web}}" data-error="Introduzca una página web" required>
                                        <div class="help-block form-text with-errors form-control-feedback"></div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status" data-error="Por favor seleccione un dia" class="form-control" required>
                                            <option value="1" {{$customer->status == 1 ? 'selected' : ''}}>Sí</option>
                            ...
                            <div class="row" id="app">
                                <div class="col-md-2" v-for="(image, imgIndex) in images">
                                    <div id="preview">
                                        <img class="w-100 mb-3" v-if="images[imgIndex].url" :src="`/storage/${images[imgIndex].url}`" />
                                    </div>
...
<script>
    const aplication = new Vue({
        ...
        methods: {
            removeImage: function(i){this.images[0].url = null},
