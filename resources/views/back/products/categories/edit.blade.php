                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="searcher_order" class="form-control" value="{{$category->searcher_order}}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select class="select2" name="sup_product_category" required>
                                                    ...
                                                    <option {{$category->sup_product_category == $c->id ? 'selected' : ''}} value="{{$c->id}}">{{$c->name}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="footer_description" type="text" class="form-control" name="productCategoryLanguages[{{ $idioma->id }}][footer_description]" rows="6">{{$category->lang($idioma->id)->footer_description ?? ""}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
