...
<div class="content-i">
    <div class="content-box">
        <div class="element-wrapper">
            <h6 class="element-header">Etiquetas ({{ $labels->count() }})
                <a href="{{ route('labelUpdate') }}" class="btn btn-primary float-right"><i class="ti-plus"></i> Nuevo</a>
            </h6>
            @if(session('messages'))
                                ...
                                <td class="td-acciones">
                                    <div class="btn-group">
                                        ...
                                        <div aria-labelledby="dropdownMenuButton2" class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="{{ route('labelUpdate', $label->id) }}">
                                                <i class="icon-pencil"></i> Editar
                                            </a>
                                            <a class="delete-register dropdown-item" href="#" data-url="{{ route('labelDelete', $label->id) }}" data-toggle="modal" data-target="#modal-delete"><i class="icon-trash"></i> Eliminar</a>
...
@endsection
@section('swal.error.text', "La etiqueta no se ha podido borrar porque se esta usando")
