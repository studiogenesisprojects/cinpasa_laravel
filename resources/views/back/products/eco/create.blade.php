            ...
            <div class="col-sm-12">
                <div class="element-wrapper">
                    <div class="element-box">
                        <form id="formValidate" novalidate="true" method="post" enctype="multipart/form-data" action="{{route('eco.store')}}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="image" class="form-control" data-error="Introduzca una imagen" required>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="name-{{ $key }}" type="text" class="form-control title" name="languages[{{ $idioma->id }}][name]" required>
                                                    </div>
                                                </div>
