            ...
            <div class="col-sm-12">
                <div class="element-wrapper">
                    <div class="element-box">
                        <form id="formValidate" novalidate="true" method="POST" action="{{route('tonalidades-colores.update', $shade->id)}}">
                            {{ csrf_field() }}
                            @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="searcher_order" value="{{$shade->searcher_order}}">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="os-tabs-w">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="title" type="text" class="form-control" name="colorLanguages[{{ $idioma->id }}][name]" value="{{$shade->lang($idioma->id)->name ?? ""}}">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">Slug</label>
                                                        <input id="slug" type="text" class="form-control" name="colorLanguages[{{ $idioma->id }}][slug]" value="{{$shade->lang($idioma->id)->slug ?? ""}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea class="form-control" name="colorLanguages[{{ $idioma->id }}][description]" cols="30" rows="6">{{$shade->lang($idioma->id)->description ?? ""}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
                                ...
                                <div class="col-12 py-3">
                                    <applications :name="'colors[]'" :items="{{$colors}}" :sitems="{{$shade->colors->sortBy('pivot.order')}}"></applications>
                                </div>
                            </div>
                            {{-- Error messages --}}
                            @if ($errors->any())
