...
<div class="content-box">
    <div class="element-wrapper" id="app">
        ...
        <div class="alert alert-danger">
            <p>No se ha podido actualizar el usuario</p>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" data-error="El nombre es obligatorio" required value="{{$user->name}}">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email" class="form-control" data-error="El email es obligatorio" required value="{{$user->email}}">
                                        <div class="help-block form-text with-errors form-control-feedback"></div>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <button user="{{$user->id}}" class="btn toggle-user btn-sm ml-3 mt-4-special {{$user->active ? "btn-danger" : "btn-primary"}} ">{{$user->active ? "Desactivar" : "Activar"}}</button>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
