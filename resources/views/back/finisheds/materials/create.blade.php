    ...
    <div class="content-box">
        <div class="element-wrapper">
            ...
            <div class="element-box">
                <h5 class="form-header">Nuevo Material</h5>
                <hr>
                <form action="{{ route('materiales-acabados.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="materials[{{ $language->id }}][name]" class="form-control" data-error="Introduzca un nombre" required>
