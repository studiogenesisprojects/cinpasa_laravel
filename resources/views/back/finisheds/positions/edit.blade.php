...
<div class="content-i">
    <div class="content-box">
        <div class="element-wrapper">
            <h6 class="element-header">Posición de acabados
                    <a href="{{route('posiciones.index')}}" class="btn btn-white float-right"><i
                    class="os-icon os-icon-chevron-left"></i> Volver</a>
            </h6>
        <div class="element-wrapper">
            <div class="element-box">
                <h5 class="form-header">Nuevas posiciones</h5>
                <hr>
                <form action="{{ route('posiciones.update', $finishedPosition->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    <div class="row">
                        <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $finishedPosition->lang($language->id)->name }}" type="text" name="posiciones[{{ $language->id }}][name]" class="form-control" data-error="Introduzca un nombre" required>
