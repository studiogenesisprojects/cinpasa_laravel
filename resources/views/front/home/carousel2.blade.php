        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="false">
            ...
            @foreach ($carousel->slides as $slide)
                <div class="carousel-item position-relative overflow-hidden bg-cover bg-xl {{$loop->first == 1 ? 'active' : ''}}" style="background-image: url('{{Storage::url($slide->image)}}');">
                    <img src="{{isset($news) ? Storage::url('noticias/'.$featuredNews[0]->news->image) : Storage::url($slide->image) }}" class="d-block w-100 w-lg-150 w-sm-200 w-xs-400" alt="primero slide">
