                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-md-8 col-10 offset-xl-0 offset-1">
                                    ...
                                    <a href="productos.php" title="saber más sobre líderes en fabricación de cintas y cintas para cortinas" class="btn btn-secundary mt-3">SABER MÁS <img class="ml-4 mb-1" src="{{ asset('front/img/icon-arrow-right.svg') }}" alt="Icono flecha derecha"></a>
